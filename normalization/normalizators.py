# Adaptation of Matyas Bohacek's code
...
def normalize_landmarks(landmarks: dict) -> (bool, dict):    
    """
    Normalizes the given skeletal data.

    :param landmarks: Dictionary containing key-value pairs ("landmark_name": (x,y))
    :return: Dictionary with normalized skeletal data
    """
